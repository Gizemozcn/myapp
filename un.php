		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="un.php">Featured Recipes</a>
					</li>
					<li>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<a href="pt.php"><img src="images/ba.png" height="50" width="50"></a>
							<a href="index.html"><img src="images/un.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="directions">
								<li>
									Bir kasede sıcak suyu ve toz şekeri karıştırın. 
								</li>
								<li>
									Çelik tencerede margarini ve sıvı yağı eritin sonra unu ilave ederek tahta kaşıkla karıştırın(un kahve rengi allana kadar).
								</li>
								<li>
									 Sonra cevizleri ekleyin ve 5 dakika daha karıştırın.
								</li>
								<li>
									Sıcak suyu ilave edin yavaş yavaş ve her zaman karıştırın(top top olmasın diye). 
								</li>
								<li>
									  Ocaktan aldıktan sonra çorba kaşığıyla şekil verin.
								</li>
