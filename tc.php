		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="tc.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/tc.jpg" height="300" width="650" alt="Image"></a>
							<img src="images/yemek_tarifi_hazirlanisi.png">
							<ol class="ingredients">
								<li>
									1/2 çay bardağı ev tarhanası
								</li>
								<li>
							...
							<ol class="directions">
								<li>
									Bir bardak sıcak ile tarhana ayrı bir kapta karıştırılır.	
								</li>
								<li>
									Kalan 4 bardak su tencerede kaynatılır. 
								</li>
								<li>
									Daha sonra ayrı bir kapta karıştığımız tarhana, kaynamakta olan suya yavaş yavaş eklenir. 
								</li>
								<li>
									Kaynayıncaya kadar karıştırılır. Tarhana kaynamaya başladığında tuz ve tereyağı eklenir.
								</li>
								<li>
									2 dakika daha karıştırılarak pişirilir ve tarhana çorbamız hazır.
								</li>
