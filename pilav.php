					...
					<div>
						<ul>
							<li>
								...
								<a href="home.html"><img src="images/mantarlibulgulpilavi.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="mantarlibulgurpilavi.php">MANTARLI BULGUR PİLAVI</a></h3>
									
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/paella.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="paella.php">PAELLA</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/sebzelipilav.jpg" height="150" width="150"alt="Image"></a>
								<div>
									<h3></br></br></br><a href="sebzelipilav.php">SEBZELİ PİLAV</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/pirincpilavi.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="pirincpilavi.php">PİRİNÇ PİLAVI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/sehriyepilavi.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="sehriyepilavi.php">ŞEHRİYE PİLAVI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/kisir.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="kisir.php">KISIR</a></h3>
