				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/mc.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="ingredients">
								...
								<li>
									2 su bardağı mantar (her çeşit olur, çok ince doğranmış)
								</li>
								<li>
									2 yemek kaşığı un
								</li>
							...
							<ol class="directions">
								<li>
									Tereyağını tencerede eritiyoruz, ve ince doğranmış mantarları soteliyoruz.								</li>
								<li>
									Unu ilave edip biraz kavuruyoruz.
								</li>
								<li>
									  Sırayla süt, kaymak ve tavuk suyunu (veya su) ekleyip kaynatıyoruz.
								</li>
								<li>
									Kaynadıktan sonra ocağın altını kısıp tuzu, karabiber ve suyu ayarlıyoruz.
								</li>
								<li>
									 5 dakika daha kısık ateşte pişiriyoruz. 
								</li>
