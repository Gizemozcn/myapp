		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="misirlisalata.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/misirlisalata.jpg" height="300" width="650" alt="Image"></a></center>
...
1 tane havuç
								...
								<li>
Yarım demet tere, roka ,maydanoz, dereotu

								</li>
								<li>
1 tane domates salatalık
...
1 kaşık nar ekşisi
							...
							<ol class="directions">
								<li>
Tüm yeşillikler doğranır. Domates salatalık küp küp doğranır. Havuç rendelenir.Salata kasesine konulur	</li>
								<li>
Diğer taraf da sosu için zeytinyağ, sirke, nar ekşisi tuz karıştırıp salatanın üzerine dökülür.Son olarak mısır dökülür.	</li>
								<li>
									 Afiyet olsun.
								</li>
