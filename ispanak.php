...
<body>
	...
	<div class="body">
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/ıspanak.jpg" height="300" width="650" alt="Image"></a></center>
		...
		Tuz, pul biber
							...
							<ol class="directions">
								<li>
								Ispanaklar yıkanır ,doğranır ,soğan küp halinde küçük ve ince doğranır, sıvı yağ tencereye alınır, içine soğanları pembeleşinceye kadar kavrulur ,salça eklenir ,biraz kavrulur
								</li>
								<li>
içine ıspanaklar eklenir karıştırılır ,altı kısılır 5 dakika ıspanaklar soluncaya kadar kavrulur ,sonra üzerine 3 su bardağı su eklenir üzerine bulgur ilave edilir, bulgurlar pişene kadar orta ateşte pişirilir.							</li>
								<li>
									 Afiyet olsun.
								</li>
