		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="sehriyepilavi.php">Featured Recipes</a>
					</li>
					<li>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<a href="pilav.php"><img src="images/ba.png" height="50" width="50"></a>
							<center><a href="index.html"><img src="images/sehriyepilavi.jpg" height="300" width="650" alt="Image"></a></center>
							<img src="images/yemek_tarifi_hazirlanisi.png">
							<ol class="ingredients">
								<li>
								Yarım paket tel ya da arpa şehriye
...
2 adet biber
							...
							<ol class="directions">
								<li>
Öncelikle sebzeleri ayrı bir tavada çok yakmadan kızartıyoruz. Sonra sebzelerin üzerine salçayı ve baharatları ekleyip kapatıyoruz. Ayrı bir tencereye 2 yemek kaşığı yağ koyup şehriyeleri 10 dakika kadar kavuruyoruz.			</li>
								<li>
Renkleri pembeleşmeye başlayınca tavadaki sebzeleri içine karıştırıp, üzerini bir parmak asacak şekilde sıcak su ilave ediyoruz. Tuzunu da ekleyip pişmeye bırakıyoruz. Suyunu çekince yarım saat kadar dinlendiririyoruz. Dinlenirken arada bir karıştırmayı unutmayın yoksa şehriye pilavı hemen topaklanır:-) Yoğurtla servis ederseniz daha lezzetli olur	</li>
								<li>
									 Afiyet olsun.
								</li>
