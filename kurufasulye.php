		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="mc.php">Featured Recipes</a>
					</li>
					<li>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<a href="sy.php"><img src="images/ba.png" height="50" width="50"></a>
							<center><a href="index.html"><img src="images/kurufasulye.jpg" height="300" width="650" alt="Image"></a></center>
...
Tuz
								...
								Fasulyelerin üzerini geçecek kadar sıcak su
								</li>
							...
							<ol class="directions">
								<li>
Bir gece önceden ıslatılmış fasulyeler 10-15 dk haşlanır. Ocağın altı kapatılır. Bu şekilde üzerine 1 su bardağı soğuk su eklenerek kapağı kapatılıp yarım saat dinlenmeye bırakılır. Bu arada yemeklik doğranan soğan yağda, pembeleşinceye kadar kavrulur							</li>
								<li>
Yıkanıp süzülen fasulyeler tencereye eklenip salçası katılır ve dibi kuruyana kadar(5-10 dk) karıştırılarak kavrulur. Üzerini biraz geçecek şekilde sıcak su ilave edilir(istediğiniz kıvama göre suyunu ayarlayabilisiniz). Baharatları ve tuzu atıldıktan sonra düdüklü tencerenin kapağı kapatılır ve fasulyeler 25-30 dk pişirilir. 		</li>
								<li>
									 Afiyet olsun.
								</li>
