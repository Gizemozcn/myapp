		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="sulukofte.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/sulukofte.jpg" height="300" width="650" alt="Image"></a></center>
							...
							<ol class="ingredients">
								...
								<li>
								Çok az sıvı yağ ya da tereyağı
								</li>
								<li>
							...
							<ol class="directions">
								<li>
									Tüm köfte malzemelerini harmanlayıp minik minik köfteler elde edin, daha sonra havuç ve patatesi temizleyip minik şekilde doğrayın, önce tencereye çok az sıvı yağ ekliyoruz (tereyağı da kullanabilirsiniz).
								</li>
								<li>
Sonra salçasını ekleyin ve karıştırın. Havuçları biraz soteleyin, daha sonra patatesi ekleyin, onları da biraz kavurup suyunu ekleyin, biraz kaynadığı zaman köfteleri de içine ekleyin, patatesler yumuşamaya başladığında limon ve nar ekşisini tencereden çorbanın suyundan kaşık kaşık alıp karıştırarak ekleyin. Biraz dinlendirip servis edin								</li>
								<li>
									 Afiyet olsun.
								</li>
