		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="sut.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/sutlac.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="directions">
								<li>
									Pirincimizi ilk önce haşlıyoruz sonra süzülür. Süte ilave edilir. 
								</li>
								<li>
									İçine şekeri, nişastayı, vanilyayı ekleyerek bir iki kaynatılır.
								</li>
								<li>
									 Sonra güveç kaplarına ölçülü bir şekilde kepçe yardımıyla önceden ısıtılmış fırında üzeri kızarana kadar 250 ° pişirilir. 
								</li>
								<li>
									Buzdolabına konularak ertesi günü servise hazırdır. 
								</li>
								<li>
									  Dinlenirse daha kıvamında oluyor.
								</li>
