					...
					<div>
						<ul>
							<li>
								...
								<a href="home.html"><img src="images/sehriyelisalata.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="sehriyelisalata.php">ŞEHRİYELİ SALATA</a></h3>
									
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/misirlisalata.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="misirlisalata.php">MISIRLI SALATA</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/patlicansalatasi.jpg" height="150" width="150"alt="Image"></a>
								<div>
									<h3></br></br></br><a href="patlicansalatasi.php">PATLICAN SALATASI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/patatessalatasi.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="patatessalatasi.php">PATATES SALATASI</a></h3>
