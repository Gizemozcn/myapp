		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="st.php">Featured Recipes</a>
					</li>
					<li>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<a href="cc.php"><img src="images/ba.png" height="50" width="50"></a>
							<a href="index.html"><img src="images/st.jpg" height="300" width="650" alt="Image"></a>
							<img src="images/yemek_tarifi_hazirlanisi.png">
							<ol class="ingredients">
								...
								<li>
									6 su bardağı su (tavuk göğsünü haşlamak için)
								</li>
								<li>
									1 adet limon
								</li>
							...
							<h5><img src="images/yemek_tarifinin_malzemeleri.jpg"></h5>
							<ol class="directions">
								<li>
									Öncelikle 6 su bardağı su ile tavuğumuzu haşlıyoruz tavuk haşlandıktan sonra tavuğu ayırıp ayrı bir yerde ayıklıyoruz.
								</li>
								<li>
									Sonra suyumuzun içine şehriyeleri ilave ediyoruz.
								</li>
								<li>
									 Şehriyeler pişince tavuk parçalarını ilave ediyoruz.
								</li>
								<li>
									Bir taşım kaynatıyoruz. 
								</li>
								<li>
									 Ayrı bir kapta tuzu limonu yumurta sarısını unu ve sarımsakları rendeleyip çırpıyoruz.
								</li>
								<li>
									 Çorbayı kestirmemek için kaynayan çorba suyundan alıp hızlıca terbiyesini karıştırıyoruz ve çorbaya ekliyoruz iki dk kaynatıp altını kapatıyoruz.
								</li>
								<li>
									Tereyağını yakmamak için son aşamada pişen çorbamıza baharatlarla birlikte ekliyoruz.
								</li>
								<li>
									Özellikle kendimizi halsiz hissettiğimiz de içebiliriz şifa çorbası üzerine bol limonla.								
								</li>
								<li>
									Mükemmel oluyor.Afiyet Olsun.
								</li>
