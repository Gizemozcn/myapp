		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="sebzelipilav.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/sebzelipilav.jpg" height="300" width="650" alt="Image"></a></center>
...
1 su bardağı bulgur
							...
							<ol class="directions">
								<li>
Bütün malzemeleri küçük küçük doğrayıp pilav tenceresine koyuyoruz. Biraz ocakta durduktan sonra bulgurumuzu ve tuzumuzu ilave ediyoruz. Piştikten sonra servis yapıyoruz çok leziz bir tarif</li>
								<li>
									 Afiyet olsun.
								</li>
