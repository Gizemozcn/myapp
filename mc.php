				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/mer.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="directions">
								<li>
									Mercimeği yıkayıp düdüklüye koyuyoruz üzerine soğanı soyup dörde bölüp koyuyoruz biberi iri iri doğrayıp koyuyoruz nane hariç baharatları tuzu salçayı sıvı yağı bulyonu (sağlıksız biliyorum ama çok güzel tat veriyor)koyuyoruz suyunu da koyup ocağa koyuyoruz.
								</li>
								<li>
									Kaynayınca altını kısıp 15 dakika tutuyoruz sonra naneyi de koyuyoruz blendır dan geçirip servis yapıyoruz.
								</li>
								<li>
									 Afiyet olsun.
								</li>
