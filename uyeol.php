...
<form align="center" size="12" method = "POST" action = "kayit.php">
<p><b>First name :</b> <input type="text" name="firstname" required /></p>
<p><b>Last name : </b><input type="text" name="lastname" required /></p>
<p><b>User Name :</b><input type="text"  name="username" required /></p>
<p><b>Password :</b><input  style="margin-left:10px; " type="password" name="password" required /></p>
<p><b>E-Mail :</b><input type = "email" name = "email" required /></p>
<input type="radio" name="sex" value="male">Male
<input type="radio" name="sex" value="female">Female<br><br>


<p> <input class="buton" type="submit" value="SUBMİT"  />   </p>
