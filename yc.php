		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="yc.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/yc.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="ingredients">
								...
								<li>
									1 su bardağı haşlanmış aşurelik buğday (pirinçte olur)
								</li>
							...
							<ol class="directions">
								<li>
									Yoğurt, un ve yumurtayı tencereye alarak iyice çırpıyoruz.
								</li>
								<li>
									Üzerine 5 su bardağı su ekleyip karıştırıyoruz. 								
								</li>
								<li>
									  Bulyonu da ekleyip kısık ateşte kaynayana kadar karıştırıyoruz. 
								</li>
								<li>
									Kaynadıktan sonra tuz ve buğdayı ekleyip 10 dakika daha kaynatıp ocağı kapatıyoruz.
								</li>
								<li>
									  Üzerine isterseniz yağda nane kızartıp dökebilirsiniz.
								</li>
								<li>
									 Afiyet olsun.
								</li>
