				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/kisir.jpg" height="300" width="650" alt="Image"></a></center>
...
İstenilen miktar da maydanoz
							...
							<ol class="directions">
								<li>
Evet hanımlar öncelikle 6 çay bardağı ince bulgurumuzu derin bir kaba alıyoruz. 1 çorba kaşığı domates salçamızı ve 1 çorba kaşığı biber salçamızı ilave ederek karıştırıyoruz. Salçayı bulgurumuza yedirdikten sonra 5 su bardağı sıcak suyumuzu ilave ederek ağzını kapatıyoruz ve suyunu çekmesini bekliyoruz.		</li>
								<li>
 Bu arada yeşilliklerimizi de istediğimiz boyda doğruyoruz. Bulgurumuz suyunu çektikten sonra baharatlarını ve yeşilliklerini ekleyebiliriz. İsteğe göre domates ya da salatada eklenilebilir. Ama benim tercihim bu yönde.	</li>
								<li>
									 Afiyet olsun.
								</li>
