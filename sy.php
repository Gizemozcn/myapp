					...
					<div>
						<ul>
							<li>
								...
								<a href="home.html"><img src="images/sulukofte.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="sulukofte.php">SULU KÖFTE</a></h3>
									
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/tazefasulye.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="tazefasulye.php">TAZE FASULYE</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/bamya.jpg" height="150" width="150"alt="Image"></a>
								<div>
									<h3></br></br></br><a href="bamya.php">BAMYA</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/tavuklubezelye.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="tavuklubezelye.php">TAVUKLU BEZELYE</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/ıspanak.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="ispanak.php">ISPANAK</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/kurufasulye.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="kurufasulye.php">KURU FASULYE</a></h3>
