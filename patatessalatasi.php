		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="patatessalatasi.php">Featured Recipes</a>
					</li>
					<li>
			...
			<div class="body">
				<div id="content">
					<div>
						<div>
							<a href="salata.php"><img src="images/ba.png" height="50" width="50"></a>
							<center><a href="index.html"><img src="images/patatessalatasi.jpg" height="300" width="650" alt="Image"></a></center>
							<img src="images/yemek_tarifi_hazirlanisi.png">
							<ol class="ingredients">
								<li>
		5 tane orta boy patates haşlanmış
...
Kara biber
							...
							<ol class="directions">
								<li>
İlk önce patatesleri bir kaba alıp tereyağ ile eziyoruz ve baharatlarını ekliyoruz, sonra soğanı iki dakika az sıvı yağ ile kavuruyoruz, maydanoz da ekleyip karıştırıyoruz	</li>
								<li>
hafif çiğ kalsın maydanozlar sonra onları da patatese ekleyip karıştırın ve ıslanmış silikon kaplara doldurun, tabağa ters çevirin ve üzerine ister mayonez ister salatcreme sıkın, yanına turşu biber koyup süsleyin.</li>
								<li>
									 Afiyet olsun.
								</li>
