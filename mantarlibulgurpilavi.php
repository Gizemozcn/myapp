		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="mantarlibulgulpilavi.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/mantarlibulgulpilavi.jpg" height="300" width="650" alt="Image"></a></center>
							<img src="images/yemek_tarifi_hazirlanisi.png">
							<ol class="ingredients">
								<li>
								10 adet mantar orta boy
...
Tuz
							...
							<ol class="directions">
								<li>
Mantarlarımızı ufak doğrayıp limonlu suda bir müddet bekletiyoruz. Tencereye yağımızı koyup kavuruyoruz mantarı ekliyoruz 				</li>
								<li>
hafif rengi dönünce bulgurumuzu tuzumuzu ve suyumuzu ilave edip yüksek ateşte kaynadıktan sonra kısık ateşte suyunu çekene kadar pişiriyoruz. 20 dk kadar pilavı dinlendirdikten sonra servise hazır hale gelmiştir.	</li>
								<li>
									 Afiyet olsun.
								</li>
