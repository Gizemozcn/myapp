		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="ez.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<a href="index.html"><img src="images/ez.jpg" height="300" width="650" alt="Image"></a>
							...
							<ol class="directions">
								<li>
									Düdüklü tencerede önce rendelemiş olduğumuz soğanı ve ezmiş olduğumuz sarımsağı tereyağında kavuruyoruz. 
								</li>
								<li>
									Soğanlar kavrulunca naneyi, kırmızı biberi ve salçayı ilave ederiz.
								</li>
								<li>
									Bir iki karıştırdıktan sonra yıkadığımız mercimeği, pirinci, bulguru ve tuzunu da ilave ederek karıştırıyoruz.
								</li>
								<li>
									Başka bir tarafta kaynamakta olan 2 litreye yakın suyu üzerine boşaltıyoruz. 
								</li>
								<li>
									Düdüklünün kapağını ve düdüğünü kapattıktan sonra 10 dakika pişiriyoruz.
								</li>
								<li>
									Normal tencerede de yapabilirsiniz ama biraz daha geç pişecektir.
								</li>
								<li>
									 Afiyet olsun.
								</li>
