	...
	<div class="body">
		<div>
			...
			<div class="body">
				<div id="content">
					<div>
					<a href="recipes.html"><img src="images/ba.png" height="50" width="50"></a>
						<ul>
							<li>
								<a href="home.html"><img src="images/mer.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="mc.php">MERCİMEK ÇORBASI</a></h3>
									
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/ez.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="ez.php">EZOGELİN ÇORBASI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/st.jpg" height="150" width="150"alt="Image"></a>
								<div>
									<h3></br></br></br><a href="st.php">TAVUK ÇORBASI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/mc.jpg" height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="mantarc.php">MANTAR ÇORBASI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/tc.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="tc.php">TARHANA ÇORBASI</a></h3>
									
								</div>
							</li>
							<li>
								<a href="home.html"><img src="images/yc.jpg"height="150" width="150" alt="Image"></a>
								<div>
									<h3></br></br></br><a href="yc.php">YOĞURT ÇORBASI</a></h3>
