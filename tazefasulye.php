		...
		<div>
			<div class="header">
				<ul>
					...
					<li class="current">
						<a href="tazefasulye.php">Featured Recipes</a>
					</li>
					<li>
				...
				<div id="content">
					<div>
						<div>
							...
							<center><a href="index.html"><img src="images/tazefasulye.jpg" height="300" width="650" alt="Image"></a></center>
							...
							<ol class="directions">
								<li>
									Düdüklü tencerede doğranmış kuru soğanı sıvı yağ ile kavuruyoruz. Sonra salça ve doğranmış domates ekleyip kavuruyoruz. Doğradığımız taze fasulyeleri ve baharatları da ekleyip biraz daha kavuruyoruz. 
								</li>
								<li>
